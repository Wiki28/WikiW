...
async def hmm(client, message):
    ...
    if chat_id in en_chats:
        ...
        test = test.replace("Wiki", "Aco")
        test = test.replace("My god is @WikiTapiOrang", "I'm a Christian")
        ...
        response = response.replace("luna", "Wiki")
        response = response.replace("I'm a Christian", "My god is @WikiTapiOrang")
...
@pbot.on_message(filters.regex("Wiki|Wiki|robot|Wiki|sena") & ~filters.bot & ~filters.via_bot  & ~filters.forwarded & ~filters.reply & ~filters.channel & ~filters.edited)
async def inuka(client, message):
    msg = message.text
    if msg.startswith("/") or msg.startswith("@"):
        message.continue_propagation()
